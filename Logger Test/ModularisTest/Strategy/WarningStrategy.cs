// ------------------------------------------------------------------------------------
// <copyright file="WarningStrategy.cs" company="JHT">
...
namespace ModularisTest.Strategy
{
    ...
    public class WarningStrategy : ILogType
    {
        /// <summary>
        ///
        /// </summary>
        ...
        {
            logData.message = ConfigurationManager.AppSettings["WarningMessage"];
            ...
            return ResourcesGeneral.StrategyWarning;
        }
    }
}